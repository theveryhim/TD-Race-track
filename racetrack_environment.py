...
class RaceTrackEnv:
    ...
    def render(self):
        """Render the current position of the agent within the track"""
        plt.figure(figsize=(5,5))

        # draw the track
        plt.imshow(self.course, cmap='hot', interpolation='nearest')

        # draw the car
        y, x = self.position
        plt.scatter(x, y, c='cyan', s=120, edgecolors='black', linewidths=1.5)
